// components/bitcoin-price-chart.tsx  — REPLACE your existing file with this
"use client"
...
// Mock Bitcoin price data (unchanged)
const priceData = {
  "1D": [
...
export function BitcoinPriceChart() {
  ...
  return (
    <Card className="glass border-primary/20">
      ...
      <CardContent>
        {/* Clip the chart strictly so the SVG cannot overflow */}
