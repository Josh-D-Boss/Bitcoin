...
export default function HomePage() {
  const stats = [
    { label: "Market Cap", value: "$850B", icon: TrendingUp },
    { label: "24h Volume", value: "$28.5B", icon: Globe },
    { label: "Circulating Supply", value: "19.7M BTC", icon: Bitcoin },
    { label: "Total Supply", value: "21M BTC", icon: Lock },
  ]
