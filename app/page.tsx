// app/page.tsx — overflow fix applied "use client"
...
{/* Hero Section */}
  <section className="pt-24 pb-16 gradient-bg relative overflow-hidden">
    {/* ❗ Absolute bg is clipped to section; prevent layout overflow */}
    <div className="absolute inset-0 w-full h-full bg-[url('/abstract-digital-pattern.png')] bg-cover bg-center bg-no-repeat opacity-10" />
