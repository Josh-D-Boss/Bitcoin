...
return ( <div className="min-h-screen overflow-x-hidden"> <Navigation />

{/* Hero Section */}
  <section className="pt-24 pb-16 gradient-bg relative overflow-hidden">
    <div className="absolute inset-0 w-full h-full bg-[url('/abstract-digital-pattern.png')] bg-cover bg-center opacity-10"></div>
    <div className="container mx-auto px-4 relative max-w-full overflow-hidden">
      ...
      <div className="mt-16 animate-float">
        <div className="w-32 h-32 mx-auto bitcoin-gradient rounded-full flex items-center justify-center overflow-hidden">
  ...
  <section className="py-16 bg-muted/30">
    <div className="container mx-auto px-4 max-w-full">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">Get started with Bitcoin in three simple steps</p>
      </div>
      <div className="grid md:grid-cols-3 gap-8">
        {steps.map((step, index) => (
          <div key={index} className="text-center group">
            ...
            {index < steps.length - 1 && <ChevronRight className="h-6 w-6 text-primary mx-auto mt-6 hidden md:block" />}
          </div>
        ))}
      </div>
    </div>
  ...
  <section className="py-16 bg-background">
    <div className="container mx-auto px-4 max-w-full">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">Join thousands of satisfied users who trust our platform</p>
      </div>
      <div className="grid md:grid-cols-3 gap-6">
        {testimonials.map((testimonial, index) => (
          <Card key={index} className="glass hover:scale-105 transition-transform overflow-hidden">
            <CardContent className="pt-6">
              ...
              <div className="flex items-center gap-3">
                <img src={testimonial.avatar || "/placeholder.svg"} alt={testimonial.name} className="w-10 h-10 rounded-full" />
                <div>
  ...
  <section className="py-16 bg-muted/30">
    <div className="container mx-auto px-4 max-w-full">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">Get answers to common questions about Bitcoin</p>
      </div>
    ...
    <div className="container mx-auto px-4 max-w-full">
      <div className="grid md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-background/80">The world's leading cryptocurrency platform for secure digital transactions.</p>
        </div>
        <div>
